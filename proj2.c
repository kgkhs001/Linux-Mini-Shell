...
int main(int argc, char *argv[]){
    ...
    if(argc == 3 && strcmp(argv[2], "mmap") == 0){
        ...
        //ending sequence
        close(fd);
        printf("num of stuff = %ld ", sb.st_size);
        printf("ascii = %d upper-case = %d lower-case = %d digits = %d spaces = %d\n", num_ascii, num_upper, num_lower, num_digit, num_space);
        exit(0);
        ...
        for(int i = 0; i < num_children; i++){
            ...
            if(i < sb.st_size){
                ...
                //if you are successful then do all this stuff
                        ...
                        printf("num of stuff = %d ", chunk_size );
                        printf("ascii = %d upper-case = %d lower-case = %d digits = %d spaces = %d\n", num_ascii, num_upper, num_lower, num_digit, num_space);
                        exit(0);
                    }
                ...
                if((pid = fork()) < 0){
                    ...
                    printf("num of stuff = %d ", sb.st_size / num_children);
                    printf("ascii = %d upper-case = %d lower-case = %d digits = %d spaces = %d\n", num_ascii, num_upper, num_lower, num_digit, num_space);
                    exit(0);   
                }
